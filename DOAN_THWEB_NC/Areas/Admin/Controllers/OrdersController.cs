...
namespace DOAN_THWEB_NC.Areas.Admin.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IDOrder,NameUser,Addresss,SDT,UnitPriceSale,OrderDate,Quantity,NameProduct,IDProduct")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IDOrder,NameUser,Addresss,SDT,UnitPriceSale,OrderDate,Quantity,NameProduct,IDProduct")] Order order)
        {
            if (ModelState.IsValid)
            {
